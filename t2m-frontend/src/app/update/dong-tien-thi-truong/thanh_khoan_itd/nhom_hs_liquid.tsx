...
const NhomHsLiquidItd = (props: any) => {
    ...
    const lines = {
        ...
        datasets: [
            {
                label: 'Hiệu suất A',
                data: data_sets?.map((item: any) => item.liquid_A * 100),
                borderColor: '#24B75E',
                pointRadius: 0,
                hoverRadius: 5,
            ...
            {
                label: 'Hiệu suất B',
                data: data_sets?.map((item: any) => item.liquid_B*100),
                fill: 'origin',
                borderColor: '#025bc4',
                pointRadius: 0,
                hoverRadius: 5,
            ...
            {
                label: 'Hiệu suất C',
                data: data_sets?.map((item: any) => item.liquid_C*100),
                fill: 'origin',
                borderColor: '#D0be0f',
                pointRadius: 0,
                hoverRadius: 5,
            ...
            {
                label: 'Hiệu suất D',
                data: data_sets?.map((item: any) => item.liquid_D*100),
                fill: 'origin',
                borderColor: '#e14040',
                pointRadius: 0,
                hoverRadius: 5,
