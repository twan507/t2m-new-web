...
const HoldingStockTable = (props: any) => {
  ...
  const filterData = (data: any) => {
    ...
    filterData = filterData
      ?.sort((a: any, b: any) => new Date(b.buy_date).getTime() - new Date(a.buy_date).getTime())
    ...
    const baseColumns: any = [
      {
        ...
        width: '2%',
        dataIndex: 'stt',
        sorter: (a: any, b: any) => a.stt - b.stt, // Sắp xếp dựa trên 'stt'
      ...
      },
      {
        ...
        dataIndex: 'stock',
        width: '14%',
        sorter: (a: any, b: any) => a.stock.localeCompare(b.stock), // Sắp xếp chuỗi 'stock'
        render: (text: string) => (
          <span style={{
            color: '#ffffff',
            fontFamily: 'Calibri, sans-serif',
