...
const NhomHsScoreItd = (props: any) => {
    ...
    const lines: any = {
        ...
        datasets: [
            {
                label: 'Hiệu suất A',
                data: data_sets?.map((item: any) => item.score_A),
                borderColor: '#24B75E',
                pointRadius: 0,
                hoverRadius: 5,
            ...
            {
                label: 'Hiệu suất B',
                data: data_sets?.map((item: any) => item.score_B),
                fill: 'origin',
                borderColor: '#025bc4',
                pointRadius: 0,
                hoverRadius: 5,
            ...
            {
                label: 'Hiệu suất C',
                data: data_sets?.map((item: any) => item.score_C),
                fill: 'origin',
                borderColor: '#D0be0f',
                pointRadius: 0,
                hoverRadius: 5,
            ...
            {
                label: 'Hiệu suất D',
                data: data_sets?.map((item: any) => item.score_D),
                fill: 'origin',
                borderColor: '#e14040',
                pointRadius: 0,
                hoverRadius: 5,
    ...
    const options: any = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: props?.ww > 767 ? 'Diễn biến dòng tiền nhóm hiệu suất' : 'Diễn biến dòng tiền nhóm hiệu suất',
                padding: {},
                font: {
